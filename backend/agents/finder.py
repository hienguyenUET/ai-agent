...
Rules:
    ...
    2. Those papers must be uploaded and published recently on arxiv.
    3. Use search_arxiv to search for papers on arxiv.
    4. Return only list of papers that is provided by search tool.
    5. Invent or make up about titles, abstracts, arxiv ids, and url-related fields are not allowed.
    6. Rank papers based on relevance to the user's query.
    7. Explain why you are returning those papers.
"""
